...
public enum GameInfo {
	...
	Brawl(
			...
			"Goal", "Be the last player standing", "Tip",
			"When battling your opponent,"
					+ " don't jump! You get more knockback!"),
	...
	Build_and_Fight(
			...
			"Goal", "Be the last team standing!", "Tip",
	...
	Dodgeball(
			...
			"Players are spawned on 2 seperate sides of the map"
					...
					+ " balls and throw them at your opponents to eliminate them, and"
	...
	TRON(
			...
			"Players are spawned on two sides of a dark arena. When you run, a trail of your"
					...
					+ " Also, don't stand still! You'll die.", "Goal",
			"Be the last team standing!", "Tip",
	...
	Boarding(
			...
			"2 teams are spawned on floating airships. Each team will have a certain amount of "
					...
					+ " drop down by 1.", "Goal",
			"Be the last team with reinforcements!", "Tip",
	...
	Hot_Potato(
			...
			"Goal", "Be the last person standing!", "Tip",
	...
	Infection(
			...
			"Goal", "Be the last human standing", "Tip",
	...
	Siege(
			...
			"Tip", "If your king dies, you won't respawn!"), Gladiators(
			"Teams",
			ChatColor.YELLOW + "4",
			"Respawn",
			ChatColor.RED + "No",
	...
	Loot(
			...
			"Goal", "Be the last competitor standing!", "Tip",
	...
	Tiers(
			...
			ChatColor.GREEN + "Yes",
			"Main",
			"4 teams all spawn with the exact same gear. Every time the team gets two"
					+ " kills, they go up a tier, getting weaker and weaker armour to fight against the"
					+ " other teams with, all the way to Tier 15.", "Goal",
			"Be the first team to reach Tier 15!", "Tip",
	...
	Storm_The_Castle(
			...
			ChatColor.GREEN + "Yes",
			"Main",
			"The barbarians have to invade the castle, trying to kill a knight, who drop"
					+ " beacons. If a barbarian picks up a beacon they need to place it on the gold block at"
					+ " the end of the castle. If a knight picks up a beacon it is saved and disappears.",
			"Goal", "Barbarians- Place 4 beacons. Knights- Defend the castle.",
			"Tip", "If you're a knight, aim for the barbarians with beacons!"),
